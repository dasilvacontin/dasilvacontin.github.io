...
var ColorLuminance, Handlebars, avatar, dbReq, doUp, fs, getRandomColor, immediate, jss, preloadedSound, projectContainer, projectList, projectsTemplate, projectsTemplateSource, reqListener, showLogo, signature, stuffContainer, stuffList, wololo;
...
stuffList = ["Mocha", "subclass-error", "CanvasDye", "Eximo.js"];
...
projectsTemplateSource = "{{#each this}}\n    <div class=\"project wow fadeInUp\">\n        \n        {{#if img}}<img src=\"{{ img }}\" />{{/if}}\n        \n        <h3>{{ name }}</h3>\n        <p>{{{desc}}}</p>\n        \n        {{#if downloads}}<p><i class=\"fa fa-cloud-download fa-fw\"></i> {{ downloads }}</p>{{/if}}\n        {{#if players}}<p><i class=\"fa fa-gamepad fa-fw\"></i> {{ players }}</p>{{/if}}\n        \n        {{#with website}}\n            <p class='text-link'><i class=\"fa fa-link fa-fw\"></i> <a href=\"{{ url }}\">{{ cleanUrl }}</a></p>\n        {{/with}}\n        {{#with github}}\n            <p class='text-link'><i class=\"fa fa-github-alt fa-fw\"></i> <a href=\"{{ url }}\">{{ cleanUrl }}</a></p>\n        {{/with}}\n        \n    </div>\n{{/each}}";
...
reqListener = function() {
  ...
  projectList = (function() {
    ...
    for (_i = 0, _len = projectList.length; _i < _len; _i++) {
      ...
      _results.push(database[projectName]);
    }
    return _results;
  })();
  stuffList = (function() {
...
(function() {
  var elapsed, loaded, logo_wait, up_wait;
  elapsed = 0;
  logo_wait = 750;
  up_wait = 1100;
  loaded = false;
...
},{"handlebars":18,"jss-browserify":19}],2:[function(require,module,exports){
